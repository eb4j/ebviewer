...
import io.github.eb4j.ebview.utils.CredentialsManager.PasswordSetResult;
import io.github.eb4j.ebview.utils.CredentialsManager.ResponseType;
    ...
    public void show(Window parent) {
        ...
        panel.okButton.addActionListener(e -> {
            ...
            if (entered.length == 0) {
                ...
                panel.errorTextArea.setText(LStrings.getString("PASSWORD_ERROR_CONFIRMATION_EMPTY"));
                ...
                panel.errorTextArea.setText(LStrings.getString("PASSWORD_ERROR_NO_MATCH"));
            }
        });
        panel.cancelButton.addActionListener(e -> StaticUIUtils.closeWindowByEvent(dialog));
        panel.doNotSetButton.addActionListener(e -> {
            String cancel = LStrings.getString("PASSWORD_CONFIRM_NOT_SET_BUTTON_CANCEL");
            String confirm = LStrings.getString("PASSWORD_CONFIRM_NOT_SET_BUTTON_OK");
            String[] options = { cancel, confirm };
            if (1 == JOptionPane.showOptionDialog(dialog,
                    LStrings.getString("PASSWORD_CONFIRM_NOT_SET_MESSAGE"), LStrings.getString("TF_WARNING"),
